...
private static String TAG ="PositionChanageActivity";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String modelFilePath = "position_change/container.jpg";
                String modelFilePath1 = "position_change/awesomeface.png";
                Assets2Sd(PositionChanageActivity.this, modelFilePath, path + File.separator + modelFilePath);
                Assets2Sd(PositionChanageActivity.this, modelFilePath1, path + File.separator + modelFilePath1);
            }
        }).start();
    }
