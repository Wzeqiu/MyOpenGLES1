...
import com.example.wzeqiu.myopengles1.es.textures.ESGLSurfaceView;
...
public class TexturesActivity extends AppCompatActivity {
    private static String TAG = "TexturesActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String modelFilePath = "textures/container.jpg";
                String modelFilePath1 = "textures/awesomeface.png";
                Assets2Sd(TexturesActivity.this, modelFilePath, path + File.separator + modelFilePath);
                Assets2Sd(TexturesActivity.this, modelFilePath1, path + File.separator + modelFilePath1);
            }
        }).start();
    }
